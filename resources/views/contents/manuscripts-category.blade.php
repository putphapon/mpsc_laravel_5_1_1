...
<section id="manuscript">
    <div class="container">
        ...
        <div class="row text-center">
            <img src="{{ asset($item->manuscripts_category_image) }}" class="rounded cardShadow w-100">
            ...
            @foreach ($manuscripts_blog as $subitem)
                ...
                <div class="col-md-4 col-sm-6 pb-5 mt-5" style="min-height: 400px;">
                    <div class="card cardShadow bg-transparent d-flex">
                        ...
                        <img src="{{ asset($subitem->manuscripts_blog_image) }}" class="card-img-top" style="max-height: 200px;" alt="">
